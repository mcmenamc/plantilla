...
export const workCenterSchema = z.object({
    ...
    hasFiel: z.boolean().optional(),
    fechaVencimiento: z.string().nullable().optional(),
    fielVencimiento: z.string().nullable().optional(),
    cerFile: z.string().optional(),
    keyFile: z.string().optional(),
    fielCerFile: z.string().optional(),
    fielKeyFile: z.string().optional(),
    ...
    customization: z.object({
        ...
        next_folio_number: z.number().nullable().optional(),
        next_folio_number_test: z.number().nullable().optional(),
        pdf_extra: z.object({
            codes: z.boolean(),
