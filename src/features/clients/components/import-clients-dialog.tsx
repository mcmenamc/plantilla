...
export function ImportClientsDialog({ open, onOpenChange }: ImportClientsDialogProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      const response = await api.post(`/customer/import/${selectedWorkCenterId}`, formData, {
        headers: {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Importa múltiples clientes mediante un archivo Excel (.xlsx).
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-zinc-500">Usa este archivo como base para rellenar tus clientes. No modifiques los nombres de las columnas.</p>
